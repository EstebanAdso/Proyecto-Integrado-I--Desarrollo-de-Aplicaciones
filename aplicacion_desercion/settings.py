...
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-fr*4dg*b0b+yshs4)d5q&1xfb*y^-b=il1_v$ikgv+tp96843k')
...
# Si existe DATABASE_URL (producción), usarla. Sino, usar configuración manual
